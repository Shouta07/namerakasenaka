...
import { CustomerList } from "@/components/field-cx/customer-list";
import { DayOneGate } from "@/components/field-cx/day-one";
import { EmptyState } from "@/components/ui/empty-state";

export const metadata = { title: "顧客フォロー" };

export default function FieldCxCustomersPage() {
  return (
        ...
        <DayOneGate
          empty={
            <EmptyState
              ...
              action={{ href: "/field-cx/roleplay", label: "接客練習で流れを確かめる" }}
              secondary={{ href: "/field-cx/labtest", label: "検査の見せ方を見る" }}
            />
          }
        >
          <CustomerList />
