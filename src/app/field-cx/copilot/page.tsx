...
import { CopilotBrief } from "@/components/field-cx/copilot-brief";
 ...
 */
export default function FieldCxCopilotPage() {
  return (
      ...
      <div className="space-y-6">
        <header>
          ...
          <h1 className="mt-2 text-2xl font-bold text-stone-900">
            記録はお使いのシステムで。<span className="text-brand-700">上達は、Field CX で。</span>
          </h1>
        ...
        <DayOneGate
          empty={
            <EmptyState
              ...
              action={{ href: "/field-cx/roleplay", label: "接客練習をはじめる" }}
              secondary={{ href: "/field-cx/labtest", label: "検査の翻訳を見る" }}
            />
          }
        >
          <CopilotBrief />
