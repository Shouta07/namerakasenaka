    ...
    <section className="rounded-3xl border border-[#e3ece3] bg-white p-5">
      ...
      <div className="mt-3 rounded-2xl bg-[#f6f9f6] p-4">
        <div className="flex items-baseline gap-2">
          <p className="text-[15px] font-bold text-stone-900">{axis.label}</p>
          <span className="text-[11px] text-stone-500">{row.name}</span>
          <span className="ml-auto text-[13px] font-bold tabular-nums text-[#3c6347]">
            {compare[selected]}% → {values[selected]}%
          </span>
        </div>
