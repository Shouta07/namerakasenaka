...
import type { VitalityDesignCustomer } from "@/lib/vitality-design/fixtures";
import {
  addFollowNote,
  getFollowNotes,
  getLineSends,
  ...
  type StoredLineSend,
} from "@/lib/vitality-design/store";
 ...
 */
export function CustomerActions({ customer }: { customer: VitalityDesignCustomer }) {
