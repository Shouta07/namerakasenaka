...
export const metadata = {
  ...
  description:
    "Vitality Design — 提案資料・実機デモ・顧客向けページ、すべてへの入り口。",
};
...
const GROUPS: HubGroup[] = [
  ...
  {
    key: "vitality-design",
    eyebrow: "VITALITY_DESIGN — 汎用サービス（横展開の看板）",
    title: "初回カウンセリング支援 Vitality Design",
    note: "1社目の設計思想から抽出した、機能を増減できるモジュール式サービス。",
    links: [
      {
        href: "/vitality-design",
        title: "Vitality Design 概要",
...
const OFFLINE_DOCS = [
  "Vitality Design 事業モデル 3層モート×抽出フライホイール（repo: docs/vitality-design/moat-and-flywheel.md）— 一番強い構造と成立条件",
  "Vitality Design SaaS サービス設計・開発設計書（repo: docs/vitality-design/saas-design.md）— MRR100万への事業/技術設計",
    ...
    <main className="min-h-[100dvh] bg-[#faf8f4]">
      <header className="border-b border-stone-200 bg-white">
        <div className="mx-auto max-w-6xl px-5 py-10 sm:px-8 sm:py-14">
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-stone-600">
            提案資料・実機デモ・顧客向けページ・Vitality Design。
      ...
      <footer className="border-t border-stone-200 bg-white">
        <div className="mx-auto max-w-6xl px-5 py-6 text-[11px] text-stone-400 sm:px-8">
          © バイタリティデザイン合同会社 — Vitality Design Hub
        </div>
      </footer>
    </main>
  );
