/**
 * Field CX — クリニック・サロンの初回カウンセリング支援サービス。
 *
 * デモ用フィクスチャ。Field CX は「機能モジュールを増減できる」ことが
 * コンセプトなので、MODULES を単一の情報源として、ナビ・トグル・
 * 各ページのガードすべてがここを参照する。
 */

export type FieldCxModuleId =
  | "counseling"
  | "labtest"
  | "copilot"
  | "roleplay"
...
export const FIELD_CX_MODULES: FieldCxModule[] = [
  {
    id: "counseling",
    name: "初回カウンセリング記録",
    short: "カウンセリング",
...
export const FIELD_CX_CUSTOMERS: FieldCxCustomer[] = [
  {
    id: "suzuki",
    name: "鈴木 さやか",
    age: 32,
