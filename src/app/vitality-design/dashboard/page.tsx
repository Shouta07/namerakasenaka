...
import { FunnelChart, StaffChart, TrendChart } from "@/components/vitality-design/charts";
import {
  FUNNEL_THIS_MONTH,
  KPI,
  MENTORING,
  MONTHLY_TREND,
} from "@/lib/vitality-design/fixtures";

export const metadata = { title: "成約の見える化" };

export default function VitalityDesignDashboardPage() {
      ...
      <div className="space-y-6">
        ...
        <DayOneGate
          empty={
            <EmptyState
              ...
              action={{ href: "/vitality-design/customers", label: "顧客フォローを見る" }}
              secondary={{ href: "/vitality-design/roleplay", label: "接客練習をはじめる" }}
            />
          }
        >
          <div className="space-y-6">
        ...
        <section className="grid grid-cols-2 gap-3 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-stone-200 bg-white p-4">
            ...
            <Link href="/vitality-design/roleplay" className="inline-flex min-h-11 items-center text-[11px] font-semibold text-brand-700 hover:underline">
              練習する →
            </Link>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          ...
          <div className="rounded-2xl border border-brand-100 bg-brand-50/50 p-5">
            ...
            <div className="mt-3.5 rounded-xl border border-brand-100 bg-white p-3">
              ...
              <Link
                href="/vitality-design/roleplay/price-hesitation"
