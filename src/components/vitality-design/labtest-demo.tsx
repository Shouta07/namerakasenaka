...
import { LabtestGame } from "@/components/vitality-design/labtest-game";
import { LabtestRadar } from "@/components/vitality-design/labtest-radar";
import {
  LABTEST_DISCLAIMER,
  LAB_JUDGEMENT_META,
  LAB_META,
...
export function LabtestDemo() {
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="sticky top-[var(--vitality-design-nav-h)] z-10 -mx-5 border-y border-stone-200 bg-white/95 px-5 py-3 backdrop-blur sm:-mx-8 sm:px-8">
