                    ...
                    <tr key={t.id} className="border-t border-stone-100">
                      ...
                      <td className="px-3 py-2 text-right">
                        <input
                          ...
                          className="h-11 w-20 rounded-md border border-stone-200 px-2 text-right text-sm"
                        />
                      </td>
                      <td className="px-3 py-2 text-right">
                        <button
                          ...
                          className="inline-flex min-h-11 items-center gap-1 rounded-md border border-stone-200 px-3 text-xs text-red-700"
                        >
