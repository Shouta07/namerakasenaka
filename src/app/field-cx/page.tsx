...
import { RoiSimulator } from "@/components/field-cx/roi-simulator";

/**
 * Field CX 概要 — 買う理由から並べる。
 *
...
export default function FieldCxHomePage() {
  return (
    <div className="space-y-12">
      ...
      <section>
        ...
        <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-stone-600">
          Field CX は、血液検査を接客に使う肌改善サロン・クリニックだけのための SaaS です。
      ...
      <section>
        ...
        <div className="mt-4 rounded-2xl border border-stone-200 bg-white p-5">
          ...
          <p className="mt-1.5 text-[12.5px] leading-relaxed text-stone-600">
            Field CX は記録の置き場所を取り替える道具ではありません。
