...
import { ACCORD_MODULES, type AccordModuleId } from "@/lib/accord/fixtures";
import { getModuleState, setModuleEnabled } from "@/lib/accord/store";
...
export function ModuleGate({
  ...
  const meta = ACCORD_MODULES.find((m) => m.id === module);
  return (
    <div className="mx-auto max-w-xl rounded-3xl border border-dashed border-stone-300 bg-white p-10 text-center">
      ...
      <p className="mt-2 text-sm leading-relaxed text-stone-600">
        Accord は必要な機能だけを選んで使えます。このモジュールを使う場合は、概要ページからオンにしてください。
      </p>
